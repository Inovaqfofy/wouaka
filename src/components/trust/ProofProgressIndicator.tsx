...
const PROOF_STEPS: ProofStep[] = [
  {
    ...
    icon: Smartphone,
    points: 15,
    action: { label: "Certifier", href: "/dashboard/borrower/profile" },
  },
  {
    id: "ussdUploaded",
    ...
    icon: Camera,
    points: 20,
    action: { label: "Capturer", href: "/dashboard/borrower/documents" },
  },
  {
    id: "smsAnalyzed",
    label: "SMS analysés",
    ...
    icon: MessageSquare,
    points: 25,
    action: { label: "Analyser", href: "/dashboard/borrower/score" },
  },
  {
    ...
    icon: FileCheck,
    points: 25,
    action: { label: "Vérifier", href: "/dashboard/borrower/documents" },
  },
  {
    id: "guarantorAdded",
    label: "Garant ajouté",
    ...
    icon: Users,
    points: 15,
    action: { label: "Ajouter", href: "/dashboard/borrower/profile" },
  },
];
            ...
            >
              ...
              {showActions && !isComplete && step.action && (
                <Button variant="ghost" size="sm" asChild>
                  <Link to={step.action.href} className="gap-1">
                    {step.action.label}
