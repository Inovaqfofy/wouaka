  ...
  "rounded-2xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-b from-card to-muted/30 border-border/50 shadow-card hover:shadow-card-hover",
        ...
        stat: "bg-card border-border/50 shadow-sm hover:shadow-md",
        score: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground border-0 shadow-glow",
      },
    },
    defaultVariants: {
      variant: "default",
