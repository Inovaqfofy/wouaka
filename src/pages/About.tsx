            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  Démocratiser l'accès au crédit en Afrique de l'Ouest en fournissant aux institutions financières 
                  des outils d'évaluation du risque précis, transparents et conformes aux réglementations locales.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Nous croyons que chaque individu et chaque entreprise mérite une évaluation juste de sa solvabilité, 
                  basée sur des données objectives et des algorithmes explicables — pas sur des préjugés ou des 
                  critères d'exclusion arbitraires.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Une approche hybride combinant données officielles, alternatives et intelligence artificielle
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="relative overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-4">Données Publiques BCEAO</h3>
                  <p className="text-muted-foreground">
                    Agrégation des informations disponibles auprès des registres officiels, 
                    fichiers centraux et bases de données réglementaires de la zone UEMOA.
                  </p>
                </CardContent>
              </Card>
              <Card className="relative overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-4">Données Alternatives</h3>
                  <p className="text-muted-foreground">
                    Analyse des transactions Mobile Money, historique de paiements 
                    de factures, comportements numériques et autres signaux non-traditionnels.
                  </p>
                </CardContent>
              </Card>
              <Card className="relative overflow-hidden">
                ...
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-4">IA Open Source</h3>
                  <p className="text-muted-foreground">
                    Modèles de machine learning explicables (XAI), entraînés sur des 
                    données africaines, auditables et conformes aux exigences réglementaires.
                  </p>
                </CardContent>
              </Card>
            </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:contact@wouaka.com" className="text-lg text-primary hover:underline">
                          contact@wouaka.com
                        </a>
                      </div>
                    </div>
