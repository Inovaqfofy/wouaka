          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <div className="bg-muted/50 p-4 rounded-lg mt-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li><strong>Email :</strong> legal@wouaka.com</li>
              </ul>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-primary pl-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      par Inopay Group SARL sous la marque Wouaka, accessibles via www.wouaka.com.
                    </p>
                  </div>
                  <div className="border-l-4 border-primary pl-4">
            ...
            <Card>
              ...
              <CardContent className="prose prose-sm max-w-none">
                ...
                <p className="text-muted-foreground mt-4">
                  ...
                  signalée immédiatement à legal@wouaka.com et constitue une fraude.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose prose-sm max-w-none">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  une demande écrite à support@wouaka.com. La fermeture prend effet :
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4">
              ...
              <CardContent>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><strong>Email :</strong> legal@wouaka.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
